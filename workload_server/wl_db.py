...
def __download_csv_file(filename: str) -> Optional[Iterator[Tuple]]:
    """
...
def __insert_file(con: sqlite3.Connection, filename: str, csv_file: Iterator[Tuple]) -> None:
    """
...
async def get_batch(bench_type: str, metrics: int, batch_unit: int, batch_id: int) -> Optional[Iterator[aiosqlite.Row]]:
    """
    ...
    :param metrics: value to enable the columns bitwise (expects between 1 and 15)
